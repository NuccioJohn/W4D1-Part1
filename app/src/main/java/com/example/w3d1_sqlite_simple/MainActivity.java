...
public class MainActivity extends AppCompatActivity {
    ...
    public void readData (View view) {
       ...
       Cursor cursor = sqLiteDatabase.query(UsersDatabaseHelper.TABLE_USERS,
        ...
        do {
            Log.d(TAG, "readData: " + cursor.getString(cursor.getColumnIndex(UsersDatabaseHelper.KEY_USER_ID)));
            Log.d(TAG, "readData: " + cursor.getString(cursor.getColumnIndex(UsersDatabaseHelper.KEY_USER_NAME)));
            Log.d(TAG, "readData: " + cursor.getString(cursor.getColumnIndex(UsersDatabaseHelper.KEY_AGE)));
    ...
    public void fillListView(View view) {
        ...
        ListView lvItems = (ListView) findViewById(R.id.line1);
